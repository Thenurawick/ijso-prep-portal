      ...
      <main className="flex-grow">
        <section className="bg-accent/10 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">A concise and student-friendly summary of all the essential theory required for the International Junior Science Olympiad (IJSO).</p>
          </div>
        </section>
        ...
        <section className="py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {subjects.map(subject => <SubjectCard key={subject.title} title={subject.title} description={subject.description} icon={subject.icon} path={subject.path} color={subject.color} />)}
            </div>
          </div>
        </section>
      </main>
